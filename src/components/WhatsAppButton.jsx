const WhatsAppButton = ({ phoneNumber = '*******', message = 'Hello! I would like to know more about IoTrenetics.' }) => {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 bg-[#25D366] w-14 h-14 rounded-full flex items-center justify-center shadow-lg hover:scale-110 hover:shadow-xl transition-all duration-300 animate-bounce-slow"
    >

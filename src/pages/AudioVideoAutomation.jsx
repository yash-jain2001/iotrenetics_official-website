  ...
  stopAmbient() {
    ...
    this._ambientOscs.forEach(({ osc, gain, lfo }) => {
      try {
        ...
        setTimeout(() => { try { osc.stop(); if (lfo) lfo.stop(); } catch (e) { console.warn("Ambient stop failed:", e); } }, 1600);
      } catch (e) {
...
const ReactiveWaveform = ({ bars = 28, height = 48, audioActive }) => {
  ...
  // Use lazy initializer for stable random heights on mount
  ...
  }, [audioActive, bars, initialHeights]);

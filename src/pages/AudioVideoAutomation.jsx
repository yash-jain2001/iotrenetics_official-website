...
const solutions = [
  {
    name: "Home Theatre",
    icon: TvIcon,
    desc: "Immersive cinematic sound engineered for your private sanctuary.",
  },
  {
    name: "Multi Room Audio",
    icon: SpeakerWaveIcon,
    desc: "Seamlessly stream high-fidelity audio throughout your entire home.",
  },
  {
    name: "Outdoor Audio",
    icon: MusicalNoteIcon,
    desc: "Weather-resistant, architectural sound for your outdoor luxury spaces.",
  },
  {
    name: "Media Rooms",
    icon: HomeIcon,
    desc: "Versatile entertainment spaces designed for both gaming and cinema.",
  },
];
...
const why = [
  {
    ...
    icon: CheckBadgeIcon,
    desc: "TruAudio is a leader in architectural audio innovation.",
  },
  {
    title: "Architectural Design",
    icon: SparklesIcon,
    desc: "Speakers that blend invisibly into your premium interiors.",
  },
  {
    title: "Luxury Experience",
    icon: StarIcon,
    desc: "Tailored soundscapes designed for the most discerning ears.",
  },
  {
    title: "Smart Integration",
    icon: CpuChipIcon,
    desc: "Full compatibility with Control4 and other smart home ecosystems.",
  },
];
    ...
    <div className="bg-[#050505] text-white overflow-x-hidden font-sans">
      ...
      <section className="relative h-screen flex items-center justify-center text-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div
            className="absolute bottom-1/4 -right-20 w-96 h-96 bg-blue-500/10 rounded-full blur-[120px] animate-pulse"
        ...
        >
          ...
          >
            <Link
              to="/contact"
              className="group relative px-8 py-4 bg-yellow-500 text-black font-bold rounded-full overflow-hidden transition-all hover:scale-105 active:scale-95 shadow-[0_0_20px_rgba(234,179,8,0.3)]"
            >
            ...
            <Link
              to="/coming-soon"
              className="px-8 py-4 border border-white/20 hover:border-white/40 bg-white/5 backdrop-blur-md text-white font-semibold rounded-full transition-all hover:bg-white/10 active:scale-95"
            >
              Explore Collections
            </Link>
          </motion.div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            >
              ...
              <div className="space-y-6 text-gray-400 text-lg leading-relaxed">
                <p>
                  At Iotrenetics, we don't just install speakers; we curate
                  acoustic environments. Every detail is engineered to deliver
                  an immersive experience that moves you.
                </p>
                <p>
                  By partnering with TruAudio, we bring you world-class
                  architectural audio that perfectly blends with your interior
                  design, disappearing into the architecture while filling the
      ...
      <section className="py-24 bg-[#0a0a0a] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-display font-bold mb-4 italic tracking-tight">
              Sonic Solutions
            </h2>
            <p className="text-gray-500 max-w-xl mx-auto">
              Tailored audio-video experiences for every corner of your estate.
            </p>
          </div>
      ...
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        >
          <h2 className="text-4xl md:text-6xl font-display font-bold tracking-tighter text-white">
            Feel the <span className="text-yellow-500 italic">Depth</span> of
            Sound
          </h2>
        </motion.div>
      </section>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
            ...
            >
              ...
              <h3 className="text-4xl font-display font-bold mb-6 italic">
                Breathtaking Home Theatre
              </h3>
              <p className="text-gray-400 text-lg leading-relaxed mb-8">
                Transform any room into a world-class cinema. We combine 8K
                projection, acoustically transparent screens, and Dolby Atmos
                surround sound to transport you directly into the action.
              </p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col lg:flex-row-reverse items-center gap-16 lg:gap-24">
            ...
            >
              ...
              <p className="text-gray-400 text-lg leading-relaxed mb-8">
                Music that follows you. Seamlessly transition your favorite
                playlists from the kitchen to the patio, or play different
                tracks in every room. Full control from your smartphone or
                wall-mounted touchscreens.
              </p>
              <div className="grid grid-cols-2 gap-4">
                <div className="p-4 rounded-2xl bg-white/5 border border-white/10 text-center">
                  <span className="text-yellow-500 font-bold text-2xl block mb-1">
                    32+
                  </span>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <p className="text-gray-500">
              Innovation meets elegance in every speaker.
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-6">
            {modes.map((m, i) => (
              ...
              >
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${m.color} opacity-80 group-hover:opacity-100 transition-opacity`}
                ></div>
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-400 max-w-2xl mx-auto mb-12">
              Let our experts design the perfect acoustic environment for your
              luxury residence. Schedule a personalized consultation today.
            </p>
            <Link
              to="/contact"
              className="inline-block px-12 py-5 bg-yellow-500 text-black font-black text-lg rounded-full hover:scale-110 active:scale-95 transition-all shadow-[0_0_40px_rgba(234,179,8,0.4)]"
            >
              Book Consultation
            </Link>
          </motion.div>

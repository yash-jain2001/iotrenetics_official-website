...
const icons = {
  ...
  cpu: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.7} className="w-4 h-4 text-blue-500">
...
// ── Data ──────────────────────────────────────────────────────────────────────
const benefits = [
  { icon: icons.cpu,      text: "Smart, reliable tech solutions tailored to your business needs." },
  { icon: icons.layers,   text: "End-to-end support from concept to live deployment." },
  { icon: icons.trending, text: "Efficiency and growth through modern digital innovation." },
  { icon: icons.message,  text: "Clear communication and rapid response, always." },
  { icon: icons.lock,     text: "Secure, scalable technologies built for long-term performance." },
];
  ...
  return (
    <div className="field-wrap">
      ...
      <span className={`field-tick ${valid && touched ? "show" : ""}`}>
        <svg viewBox="0 0 20 20" fill="none" className="w-4 h-4" stroke="#22c55e" strokeWidth={2.5}>
...
const Contact = () => {
  ...
  const handleFormChange = (e) => {
    const fields = e.currentTarget.querySelectorAll("input[required], textarea[required]");
    let filled = 0;
          ...
          <div className="left-panel flex-1 p-8 md:p-10 flex flex-col gap-8">
            ...
            <div>
              ...
              <p className="text-gray-500 text-[15px] leading-relaxed">
                Tell us what you're working on and we'll show you exactly how we can help.
              </p>
            </div>
              ...
              {status === "success" ? (
                <div className="flex flex-col items-center justify-center py-16 gap-5 text-center">
                  <div className="w-16 h-16 rounded-full bg-green-50 border border-green-200 flex items-center justify-center">
                    <svg viewBox="0 0 40 40" fill="none" className="w-8 h-8" stroke="#16a34a" strokeWidth={2.5}>
                      <polyline className="check-path" points="8 20 16 28 32 12" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                  </div>
                  <div>
                ...
                >
                  ...
                  <div className="flex gap-4 flex-col sm:flex-row">
                    <Field id="fname" name="first_name" label="First name" required />
                    <Field id="lname" name="last_name"  label="Last name" />
                  </div>

                  <Field id="email" name="email"        label="Email address" type="email"  required />
                  <Field id="phone" name="phone_number" label="Phone number"  type="number" required />
                  <Field id="msg"   name="message"      label="How can we help you?" as="textarea" />

                  <p className="text-[11px] text-gray-400 leading-relaxed">
                    By submitting, I agree to the{" "}
                    <Link to="/terms-and-conditions" className="text-blue-500 underline hover:text-blue-700">

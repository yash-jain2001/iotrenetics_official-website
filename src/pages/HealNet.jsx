...
const I = {
  ...
  Lung: () => (
    ...
    >
      <path d="M12 2v8" />
      <path d="M6.343 9.657A8 8 0 1 0 17.657 9.657" />
  ...
  Dna: () => (
    ...
    >
      ...
      <path d="M9 22c1.798-3.333 5.702-3.333 7.5 0" />
      <path d="M2 9c6.667 6 13.333 0 20 6" />
      <path d="M9 2c1.798 3.333 5.702 3.333 7.5 0" />
      <path d="M2 12h20" />
    </svg>
  ),
  Stethoscope: () => (
...
function VitalsCard() {
  return (
    <div className="card" style={{ padding: "26px 28px" }}>
      ...
      >
        <div className="ring ring-sm ring-sky">
          <I.Activity />
        </div>
        <div>
      ...
      {VITALS.map((v, i) => (
        <div key={i} style={{ marginBottom: i < 3 ? 14 : 0 }}>
          ...
          >
            <span
              style={{ fontSize: 13, color: "var(--sub)", fontWeight: 500 }}
            >
              {v.label}
            </span>
            <span
            ...
            >
              {v.val}{" "}
              <span
                style={{ fontSize: 11, fontWeight: 500, color: "var(--dim)" }}
              >
                {v.unit}
              </span>
            </span>
          ...
          >
            <div
              className="dbar"
              style={{ "--w": v.pct + "%", background: v.color }}
            />
          </div>
        </div>
      ))}
    ...
    <div className="card" style={{ padding: "26px 28px" }}>
      ...
      {state === "idle" && (
        <div className="upload-zone" onClick={analyze}>
          ...
          >
            Drop your {selected} here
          </p>
          <p style={{ fontSize: 11, color: "var(--sub)" }}>
            JPEG, PNG, PDF, DICOM · click to demo
          </p>
        </div>
      )}
      ...
      {state === "analyzing" && (
        <div style={{ padding: "24px 0", textAlign: "center" }}>
          ...
          <p style={{ fontSize: 13, color: "var(--teal)", fontWeight: 600 }}>
            AI analyzing {selected}…
          </p>
          <p style={{ fontSize: 11, color: "var(--sub)", marginTop: 4 }}>
            Cross-referencing 4.2M clinical patterns
          </p>
        </div>
      )}
      ...
      {state === "done" && (
        <div>
          ...
          {[
            {
              label: "Findings",
              val: "No critical anomalies detected",
              ok: true,
            },
...
function PupilWidget() {
  ...
  const status =
    dilation < 2.5
      ? { label: "Miosis — possible opioid/Horner's", color: "var(--rose)" }
      : dilation > 5.5
        ? {
            label: "Mydriasis — check for stimulants/trauma",
            color: "var(--amber)",
          }
    ...
    <div className="card" style={{ padding: "26px 28px" }}>
      ...
      >
        {["Left Eye", "Right Eye"].map((eye, i) => {
          const sz = Math.max(
            14,
            Math.min(46, dilation * 9 + (i === 1 ? 1 : 0)),
          );
          return (
            <div
              key={eye}
            ...
            >
              ...
              >
                ...
                <div
                  style={{
                    ...
                    borderRadius: "50%",
                    background:
                      "radial-gradient(circle at 40% 40%, #6b8fcf, #2a5298, #0d1b3e)",
                    position: "absolute",
                  }}
                />
                {/* Pupil */}
              ...
              <span
                style={{ fontSize: 11, color: "var(--sub)", fontWeight: 600 }}
              >
                {eye}
              </span>
              <span
              ...
              >
                {(dilation + (i === 1 ? 0.1 : 0)).toFixed(1)} mm
              </span>
            </div>
          );
        })}
      ...
      <div style={{ marginBottom: 14 }}>
        ...
        >
          <label style={{ fontSize: 12, color: "var(--sub)", fontWeight: 600 }}>
            Dilation: {dilation.toFixed(1)} mm
          </label>
...
function DiagnosisCard() {
  ...
  return (
    <div className="card" style={{ padding: "26px 28px" }}>
      ...
      >
        <div className="ring ring-sm ring-rose">
          <I.Brain />
        </div>
        <div>
          <p style={{ fontWeight: 600, fontSize: 14, color: "var(--ink)" }}>
      ...
      {conditions.map((c, i) => (
        <div key={i} style={{ marginBottom: i < 3 ? 14 : 0 }}>
          ...
          >
            ...
            <span
              style={{
                ...
                color: c.riskColor,
                background:
                  c.riskColor === "var(--rose)"
                    ? "var(--rose-l)"
                    : c.riskColor === "var(--amber)"
                      ? "var(--amber-l)"
                      : "var(--teal-l)",
                borderRadius: 99,
                padding: "2px 9px",
          ...
          >
            <div
              className="dbar"
              style={{ "--w": c.prob + "%", background: c.riskColor }}
            />
          </div>
          <span
            style={{
  ...
  const steps = [
    {
      icon: <I.Alert />,
      color: "var(--rose)",
      text: "Schedule cardiology consult within 2 weeks",
    },
    {
      icon: <I.Activity />,
      color: "var(--sky)",
      text: "Begin 24-hr Holter monitor for arrhythmia screening",
    },
    {
      icon: <I.Stethoscope />,
      color: "var(--teal)",
      text: "Reduce sodium intake; target BP < 130/80",
    },
    {
      icon: <I.Check />,
      color: "var(--teal)",
      text: "Sleep study referral for apnea confirmation",
    },
  ];
  return (
    <div className="card" style={{ padding: "26px 28px" }}>
    ...
    <div>
      ...
      >
        {USE_CASES.map((u, i) => (
          <button
            key={i}
            className={`uc-tab ${active === i ? "active" : ""}`}
            onClick={() => setActive(i)}
          >
            {u.tab}
          </button>
      ...
      <div
        className="card"
        style={{ padding: "32px 32px", transition: "all .3s" }}
      >
        <span
          className={`lbl ${uc.label}`}
      ...
      <div className="inner">
        ...
        >
          ...
          <div style={{ flex: "1 1 430px", minWidth: 0 }}>
            <FadeUp>
              <span className="lbl">
                <I.Brain /> Clinical AI · Diagnostic Intelligence
              </span>
            </FadeUp>
            <FadeUp className="d1">
              <h1
            ...
            <FadeUp className="d2">
              ...
              >
                Upload scans. Monitor vitals. Track pupil response and heart
                rate in real time. HealTech turns raw health data into clear
                answers — and a precise path forward.
              </p>
            </FadeUp>
            <FadeUp className="d3">
              <div
          ...
          <div style={{ flex: "1 1 340px", minWidth: 0, position: "relative" }}>
            ...
            <FadeUp className="d1">
              <img
                src="/assets/heal1.webp"
                alt="HealTech Dashboard"
                loading="eager"
                className="float"
                style={{
                  width: "100%",
                  ...
                  position: "relative",
                  zIndex: 2,
                  filter: "drop-shadow(0 28px 52px rgba(11,124,110,.13))",
                }}
              />
            </FadeUp>
            ...
            >
              ...
              >
                98<span style={{ fontSize: 13 }}>%</span>
              </p>
              <p
                style={{
                  fontSize: 10,
    ...
    <div style={{ background: "var(--teal)", padding: "20px 24px" }}>
      ...
      >
        {[
          {
            stat: "72%",
            text: "of serious conditions are missed at first check-up due to lack of continuous data",
          },
          {
            stat: "3.2 days",
            text: "average delay between symptom onset and accurate diagnosis",
          },
          {
            stat: "1 in 3",
            text: "people don't act on symptoms because they can't assess severity themselves",
          },
        ].map((s, i) => (
          <div
            key={i}
      ...
      <div className="inner">
        <FadeUp style={{ marginBottom: 52 }}>
          ...
          >
            ...
            >
              From a retinal scan to a resting heart rate — HealTech connects
              the dots your doctor doesn't have time to.
            </p>
          </div>
        </FadeUp>
              ...
              {[
                {
                  icon: <I.Scan />,
                  label: "Ingests",
                  desc: "Scans, vitals, sensor streams, uploaded reports",
                },
                {
                  icon: <I.Brain />,
                  label: "Analyses",
                  desc: "AI cross-references 4.2M+ clinical patterns",
                },
                {
                  icon: <I.Alert />,
                  label: "Flags",
                  desc: "Confidence-scored risk conditions per individual",
                },
                {
                  icon: <I.Stethoscope />,
                  label: "Guides",
                  desc: "Plain-language action plan and specialist routing",
                },
              ].map((s, i) => (
                <div
                  key={i}
          ...
          {[
            {
              ...
              body: "Heart rate, SpO₂, pupil response, respiratory rate — all tracked continuously and flagged against clinical thresholds.",
              tag: "lbl",
            },
            {
              icon: <I.Scan />,
              title: "Scan & Report Analysis",
              body: "X-rays, MRIs, CT scans, retinal images, ECG reports, blood panels — uploaded and returned with AI interpretation in under 30 seconds.",
              tag: "lbl-sky",
            },
            {
              icon: <I.Shield />,
              title: "Privacy & Clinical Grade",
              body: "Your data is never sold or profiled. Analysis runs on encrypted, HIPAA-aligned infrastructure. You own your health data.",
              tag: "lbl-amber",
            },
          ].map((f, i) => (
            <FadeUp key={i} className={`d${i + 1}`}>
              ...
              >
                <div className="ring ring-sm" style={{ marginBottom: 14 }}>
                  {f.icon}
                </div>
                <span
                  className={`lbl ${f.tag}`}
      ...
      <div className="inner">
        ...
        >
          <FadeUp style={{ flex: "1 1 360px", minWidth: 0 }}>
            ...
            >
              Whether you're managing a diagnosis, recovering from surgery, or
              just worried about something — HealTech gives you clarity, not
              more confusion.
            </p>
            <img
              src="/assets/heal2.webp"
              alt="HealTech in use"
              loading="lazy"
              style={{
                width: "100%",
                ...
                filter: "drop-shadow(0 16px 40px rgba(0,0,0,.09))",
              }}
            />
          </FadeUp>
    ...
    <section className="sec" style={{ background: "var(--bg)" }}>
      <div className="inner">
        <FadeUp style={{ textAlign: "center", marginBottom: 52 }}>
          ...
          >
            Most people have data but no interpretation. HealTech bridges the
            gap between sensor readings and actionable health understanding.
          </p>
        </FadeUp>
          ...
          {[
            {
              ...
              after:
                "AI applies clinical logic: trend detection, anomaly scoring, threshold analysis.",
              icon: <I.Activity />,
              accent: "var(--sky)",
            },
            {
              before:
                "Scan results arrive — often unread or misunderstood for weeks.",
              after:
                "Upload in seconds. AI returns plain-language findings with confidence scores.",
              icon: <I.Scan />,
              accent: "var(--teal)",
            },
            {
              before:
                "Symptoms are felt but severity is unknown — people wait or worry.",
              after:
                "HealTech scores real risk and routes to the right action immediately.",
              icon: <I.Brain />,
              accent: "var(--rose)",
            },
          ].map((item, i) => (
      ...
      >
        <FadeUp>
          <span
            className="lbl"
            style={{
              background: "rgba(11,124,110,.2)",
              borderColor: "rgba(178,224,218,.25)",
              color: "#7fd9d0",
            }}
          >
            <I.Brain />
            Clinical AI · Available Now
          </span>
          <h2
            style={{
              fontFamily: "'Lora',serif",
          ...
          >
            Stop guessing about
            <br />
            <span style={{ fontStyle: "italic", color: "#7fd9d0" }}>
              your own health.
            </span>
          </h2>
          <p
          ...
          >
            Upload a scan. Track your vitals. Ask HealTech what it means. Get a
            clear answer and a clear path — in under a minute.
          </p>
          <Link to="/contact">
            <button
              className="btn-p"
              style={{
                ...
                padding: "16px 40px",
                fontSize: 16,
                boxShadow: "0 8px 40px rgba(11,124,110,.35)",
              }}
            >
              <I.Play />
              Talk to Us

...
const IndustryRow = ({ num, name, tag, link, desc }) => (
  <Link to={link}
    ...
    <div className="flex items-center gap-5">
      <span style={{ fontFamily: "'Syne', sans-serif" }} className="ind-num text-[11px] font-bold text-gray-300 tracking-widest w-6">{num}</span>
      <div>
  ...
  <Link to={slug}
    ...
    <div className="relative flex flex-col flex-1">
      ...
      <ul className="flex flex-col gap-2.5 mb-6">
        {features.map((f, i) => (
          <li key={i} className={`flex items-center gap-2 text-sm font-medium`} style={{ color: "inherit" }}>
            <span className={ctaCls}><Check /></span> {f}
          </li>
        ))}
      </ul>
...
const AutomationBar = ({ label, pct, delay }) => (
  <div className="flex flex-col gap-1.5">
    <div className="flex items-center justify-between">
      ...
      <span style={{ fontFamily: "'Syne', sans-serif" }} className="text-xs font-bold text-blue-600">{pct}%</span>
    </div>
    <div className="h-[3px] rounded-full bg-gray-100 overflow-hidden">
      <div className="bar-fill" style={{ "--w": pct + "%", animationDelay: delay }} />
    </div>
  </div>
);
    ...
    <div className="bg-white overflow-x-hidden" style={{ fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <section className="relative text-white overflow-hidden"
        ...
        <div className="absolute inset-0 z-[1]"
          style={{ background: "radial-gradient(ellipse 80% 60% at 50% 35%, transparent 20%, rgba(0,0,0,.6) 100%)" }} />

        {/* Dot grid */}
        <div className="absolute inset-0 z-[1] pointer-events-none"
          style={{
            backgroundImage: "radial-gradient(circle, rgba(255,255,255,.3) 1px, transparent 1px)",
            backgroundSize: "36px 36px", opacity: .15,
          }} />
        ...
        <div className="absolute top-12 right-20 w-64 h-64 rounded-full pointer-events-none z-[1]"
          style={{
        ...
        {/* Content */}
        <div className="relative z-10 max-w-[1000px] w-full mx-auto text-center px-5 flex flex-col items-center justify-center"
          style={{ minHeight: "min(82vh, 680px)" }}>
          ...
          <p className="h-sub text-sm sm:text-base md:text-lg text-white/65 leading-relaxed max-w-[580px] mx-auto mb-9 font-light">
            Bridging the physical and digital worlds through IoT, AI, and intelligent
            automation — engineered for modern India.
          </p>
          ...
          <div className="h-stats flex gap-10 sm:gap-16 justify-center pt-7 border-t border-white/10 flex-wrap w-full max-w-[560px]">
            {stats.map((s, i) => (
              <div key={i} className="text-center group cursor-default">
                <div style={{ fontFamily: "'Syne', sans-serif", animation: `statIn .6s ${.72 + i * .1}s cubic-bezier(.16,1,.3,1) both` }}
        ...
        <div className="scroll-hint absolute bottom-5 left-1/2 -translate-x-1/2 z-10 flex flex-col items-center gap-1.5">
          <span style={{ fontFamily: "'Syne', sans-serif" }}
            className="text-[9px] tracking-[0.22em] uppercase text-white/35 font-bold">Scroll</span>
          <svg viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,.35)" strokeWidth="1.5" className="w-4 h-4">
        ...
        <div className="flex gap-14 items-start flex-col lg:flex-row">
          ...
          <div ref={aboutLeftRef} className="reveal-left flex-1 min-w-0">
            ...
            <h2 style={{ fontFamily: "'Syne', sans-serif" }}
              ...
              Built at the intersection<br />of hardware and intelligence
            </h2>
            <p className="text-[15px] text-gray-500 leading-relaxed mb-3">
              IoTrenetics Solutions Pvt. Ltd. is an innovative technology startup working at the
              intersection of IoT, AI, Generative AI, AR/VR, and Digital Transformation.
            </p>
            <p className="text-[15px] text-gray-500 leading-relaxed mb-7">
              Our mission is to build intelligent, connected, and sustainable systems that empower
              industries and communities across India to make smarter decisions — faster.
            </p>

            {/* Capability bars */}
            <div ref={autoRef} className="reveal flex flex-col gap-4 mb-7 p-6 border border-gray-100 rounded-2xl bg-gray-50/60">
              ...
              {automationStats.map((s, i) => (
                <AutomationBar key={i} label={s.label} pct={s.pct} delay={`${0.15 + i * 0.12}s`} />
              ))}
            </div>
          ...
          {/* Right — info grid */}
          <div ref={aboutRightRef} className="reveal-right flex-1 min-w-0 flex flex-col gap-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                ...
                <div key={item.label}
                  ...
                  <div style={{ fontFamily: "'Syne', sans-serif" }}
                    className="text-[15px] font-semibold text-gray-800">{item.value}</div>
                </div>
              ))}
            </div>
            ...
            <div className="info-card p-5 border border-gray-100 rounded-2xl bg-white flex items-center gap-4">
              ...
              <div>
                <div style={{ fontFamily: "'Syne', sans-serif" }}
                  className="text-[10px] font-bold tracking-[0.12em] uppercase text-gray-400 mb-0.5">Headquarters</div>
                <div style={{ fontFamily: "'Syne', sans-serif" }}
                  className="text-[15px] font-semibold text-gray-800">India — operating PAN India</div>
              </div>
            </div>
            ...
            <div className="info-card p-5 border border-gray-100 rounded-2xl bg-white">
              <div style={{ fontFamily: "'Syne', sans-serif" }}
                className="text-[10px] font-bold tracking-[0.12em] uppercase text-gray-400 mb-3">Active Products</div>
              <div className="flex gap-2 flex-wrap">
                {[
                  { name: "Finexo", cls: "bg-blue-50 border-blue-100 text-blue-700" },
                  { name: "HealNet", cls: "bg-emerald-50 border-emerald-100 text-emerald-700" },
                  { name: "Agentra", cls: "bg-violet-50 border-violet-100 text-violet-700" },
                ].map(p => (
                  <span key={p.name}
            ...
            <div className="info-card p-5 border border-gray-100 rounded-2xl bg-white">
              <div style={{ fontFamily: "'Syne', sans-serif" }}
                className="text-[10px] font-bold tracking-[0.12em] uppercase text-gray-400 mb-3">Technology Domains</div>
              <div className="grid grid-cols-2 gap-2">
                {["IoT & Sensors", "Generative AI", "Computer Vision", "AR / VR", "Edge Computing", "Digital Twin"].map((d) => (
      ...
      <section className="relative py-24 overflow-hidden"
        ...
        <div className="absolute inset-0 opacity-[.1] pointer-events-none"
          style={{
            backgroundImage: "radial-gradient(circle, rgba(255,255,255,.45) 1px, transparent 1px)",
            backgroundSize: "28px 28px",
          }} />
        <div className="absolute top-0 left-1/3 w-[500px] h-[400px] pointer-events-none"
          style={{ background: "radial-gradient(ellipse, rgba(37,99,235,.2), transparent 70%)", filter: "blur(60px)" }} />
        <div className="absolute bottom-0 right-1/3 w-[400px] h-[300px] pointer-events-none"
          style={{ background: "radial-gradient(ellipse, rgba(6,182,212,.12), transparent 70%)", filter: "blur(60px)" }} />
            ...
            {visionCards.map((card, i) => (
              <div key={i}
                ...
                <div className="absolute top-0 right-0 w-24 h-24 rounded-full pointer-events-none"
                  style={{ background: "radial-gradient(circle, rgba(255,255,255,.04), transparent 70%)", transform: "translate(30%, -30%)" }} />
                <div className={`icon-float w-11 h-11 rounded-xl bg-white/[.06] border border-white/[.08] flex items-center justify-center mb-5 ${card.iconColor}`}>
                  {card.icon}
                </div>
                <h3 style={{ fontFamily: "'Syne', sans-serif" }}
        ...
        <div className="relative rounded-3xl overflow-hidden px-8 sm:px-16 py-20 text-white text-center"
          ...
          <div className="relative">
            ...
            <p className="text-white/60 text-base leading-relaxed max-w-[500px] mx-auto mb-12">
              Whether you're exploring home automation or enterprise AI, we'd love to talk about

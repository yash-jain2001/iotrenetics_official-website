...
const automations = [
  ...
  },
  {
    ...
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
        <path d="M3 3h18v18H3z"/><path d="M12 3v18M3 9h4M3 15h4M17 9h4M17 15h4"/>
      </svg>
    ),
  },
  {
  ...
  },
  {
    ...
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
        <path d="M3 12V6a1 1 0 0 1 .293-.707l3-3A1 1 0 0 1 7 2h10a2 2 0 0 1 2 2v16a2 2 0 0 1-2 2H7a1 1 0 0 1-.707-.293l-3-3A1 1 0 0 1 3 18v-2"/><circle cx="14" cy="12" r="1" fill="currentColor"/>
      </svg>
    ),
  },
];
      ...
      <section className="relative bg-[url('/assets/MainHomeAutomation.webp')] bg-cover bg-center min-h-[90vh] flex items-center justify-center text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-6 flex flex-col items-center gap-6">
          ...
          <p className="hero-sub text-white/70 text-base sm:text-lg max-w-xl leading-relaxed">
            India's most trusted home automation platform — where precision engineering meets effortless living.
          </p>

          <div className="hero-btn flex items-center gap-4 flex-wrap justify-center">
            <button className="bg-blue-700 hover:bg-blue-600 text-white font-semibold text-sm px-7 py-3 rounded-full transition-all duration-200 hover:shadow-[0_0_24px_rgba(59,130,246,0.45)] hover:scale-[1.03]">
              Explore Features
            </button>
            <button className="bg-white/10 hover:bg-white/20 backdrop-blur-md border border-white/25 text-white font-semibold text-sm px-7 py-3 rounded-full transition-all duration-200">
              Watch Demo
            </button>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center gap-16 flex-col lg:flex-row">
            ...
            <div className="w-full lg:w-[45%] ha-reveal">
              ...
              <SectionHeading>
                Your Home Features<br />
                <span className="text-blue-600">At Your Fingertips</span>
              </SectionHeading>
              <p className="mt-6 text-gray-500 text-base leading-relaxed">
                A comprehensive solution for seamless household management. Our representative will guide you through every feature of our app and how it supports your lifestyle.
              </p>

              {/* Inline feature pills */}
              <div className="mt-8 flex flex-wrap gap-3">
                {['Single App Control', 'Voice Ready', 'Offline Support', 'Easy Setup'].map((tag) => (
                  <span key={tag} className="inline-flex items-center gap-1.5 bg-blue-50 border border-blue-100 text-blue-700 text-xs font-semibold px-3.5 py-1.5 rounded-full">
            ...
            <div className="w-full lg:w-[55%] ha-reveal ha-delay-2">
              <div className="relative rounded-3xl overflow-hidden border border-gray-100 shadow-[0_24px_64px_rgba(0,0,0,0.08)]">
                ...
                <div className="absolute bottom-5 left-5 bg-white/90 backdrop-blur-md border border-gray-100 rounded-2xl px-4 py-3 shadow-lg flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-[10px] text-gray-400 font-medium uppercase tracking-wider">System Status</p>
                    <p className="text-xs font-bold text-gray-900">All Devices Online</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center gap-16 flex-col lg:flex-row-reverse">
            ...
            <div className="w-full lg:w-[45%] ha-reveal">
              ...
              <p className="mt-6 text-gray-500 text-base leading-relaxed">
                Experience India's premier home automation, tailored to your rhythm. From mood-based lighting and intelligent climate control to one-tap scene setting — we don't just automate your home; we elevate your lifestyle.
              </p>
              <div className="mt-8 grid grid-cols-3 gap-4">
                {[
                  ...
                  <div key={label} className="bg-white border border-gray-100 rounded-2xl p-4 text-center shadow-sm hover:border-blue-100 hover:shadow-md transition-all duration-200">
            ...
            <div className="w-full lg:w-[55%] ha-reveal ha-delay-2">
              <div className="relative rounded-3xl overflow-hidden border border-gray-100 shadow-[0_24px_64px_rgba(0,0,0,0.07)]">
                ...
                <div className="absolute top-5 right-5 bg-white/90 backdrop-blur-md border border-gray-100 rounded-2xl px-4 py-3 shadow-lg flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-[10px] text-gray-400 font-medium uppercase tracking-wider">Energy Saved</p>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <h4 className="text-base font-bold text-gray-900 leading-snug">
                    <span className="text-blue-600">{card.accent}</span>{' '}{card.title}
                  </h4>
                </div>
                ...
                <div className="p-6 flex flex-col gap-3">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-base font-bold text-gray-900">
                      <span className="text-blue-600">{mode.accent}</span>{' '}{mode.title}
                    </h3>
                  </div>
      ...
      <section className="bg-white py-24 px-5">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16 ha-reveal">
            ...
            <SectionHeading>
              Built-in{' '}
              <span className="text-blue-600">Smart Automations</span>
            </SectionHeading>
            <p className="mt-4 text-gray-400 text-sm max-w-lg mx-auto">
              Every device in your home, working in perfect harmony — automatically.
            </p>
          </div>
              ...
              >
                ...
                <div className="flex flex-col gap-2">
                  <div className="flex items-center gap-2.5 max-md:justify-center">
                    ...
                    <h3 className="text-base font-bold text-gray-900">
                      <span className="text-blue-600">{auto.accent}</span>{' '}{auto.title}
                    </h3>
                  </div>
                  <p className="text-sm text-gray-500 leading-relaxed">{auto.desc}</p>
                </div>
              </div>
            ))}
          </div>

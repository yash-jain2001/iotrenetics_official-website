...
const useCases = [
  {
    ...
    points: [
      ...
      "Smart curtains & ambient control",
      "Occupancy-based AC scheduling",
      "DND / Make My Room control",
    ],
    reverse: false,
  },
  {
    ...
    points: [
      "Mood lighting scene presets",
      "Voice-enabled room control",
      "Outdoor & pool automation",
      "Returning guest preference recall",
    ],
    reverse: true,
  },
  {
    ...
    points: [
      "Live housekeeping tracking",
      "Room occupancy monitoring",
      "Centralized management dashboard",
      "Instant staff alert system",
    ],
    reverse: false,
  },
];
...
const EyebrowLabel = ({ children, light = false }) => (
  <p
    className={`text-[11px] font-bold tracking-[0.18em] uppercase mb-3 ${light ? "text-amber-300" : "text-amber-600"}`}
  >
    {children}
  </p>
);
      ...
      <section className="relative bg-[url('https://images.unsplash.com/photo-1566073771259-6a8506099945')] bg-cover bg-center min-h-[92vh] flex items-center justify-center text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 flex flex-col items-center gap-7">
          ...
          <h1 className="ha2-h2 text-white text-4xl sm:text-5xl md:text-[3.6rem] font-bold tracking-[-0.03em] leading-[1.1] [text-shadow:0_4px_20px_rgba(0,0,0,1)]">
            ...
            >
              Through Hotel Automation
            </span>
          </h1>

          <p
            className="ha2-h3 text-white text-base sm:text-lg max-w-xl leading-relaxed"
            style={{ textShadow: "0 2px 12px rgba(0,0,0,0.9)" }}
          >
            Seamless comfort, personalized control, and operational efficiency —
            unified in one intelligent platform built for hospitality.
          </p>
          ...
          <div className="ha2-h4 flex items-center gap-4 flex-wrap justify-center">
            <Link
              to="/contact"
              className="bg-amber-600 hover:bg-amber-500 text-white font-semibold text-sm px-8 py-3.5 rounded-full transition-all duration-200 hover:shadow-[0_0_28px_rgba(217,119,6,0.5)] hover:scale-[1.03] tracking-wide"
            >
              Request a Demo
            </Link>
            <Link
        ...
        <div className="ha2-badge absolute bottom-8 right-8 hidden md:flex items-center gap-3 bg-white/10 backdrop-blur-xl border border-white/15 rounded-2xl px-5 py-3.5">
          ...
          <div className="text-left">
            ...
            <p className="text-white/45 text-[10px]">
              Automation that guests notice & remember
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-stone-950 border-b border-white/5 py-5 px-6">
        <div className="max-w-5xl mx-auto flex flex-wrap items-center justify-center gap-x-10 gap-y-3">
          {[
            ...
            <div
              key={i}
              className="flex items-center gap-2.5 text-white/45 text-[10px] font-bold tracking-[0.18em] uppercase"
            >
            ...
            <div className="relative z-10 px-10 sm:px-16 py-14 flex flex-col lg:flex-row items-center gap-12">
              <div className="flex-1">
                ...
                <p className="mt-5 text-white/50 text-sm leading-relaxed max-w-md">
                  Hotels that automate their guest experience don't just reduce
                  costs — they create loyalty. Guests remember the room that
                  felt like it was designed for them.
                </p>
              </div>
              <div className="flex-shrink-0 w-full lg:w-64 flex flex-col gap-4">
                {[
                  ...
                  <div
                    key={i}
                    className="bg-white/8 hover:bg-white/12 border border-white/10 rounded-2xl px-6 py-4 flex items-center gap-4 transition-colors duration-200"
                  >
                    <span className="text-amber-400 text-xl font-bold w-7 text-center flex-shrink-0">
                      {icon}
                    </span>
                    <div>
                      <p className="text-white text-sm font-bold">{value}</p>
                      <p className="text-white/35 text-[10px] font-semibold uppercase tracking-widest mt-0.5">
                        {label}
                      </p>
                    </div>
                  </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16 ha2-reveal">
            ...
            <p className="mt-4 text-gray-400 text-sm max-w-md mx-auto">
              Every feature designed around one goal — a guest who checks out
              and immediately books again.
            </p>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-20 ha2-reveal">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold tracking-[-0.02em] text-gray-900 leading-tight">
              Built for Every
              <br />
              <span className="text-amber-600">Hospitality Format</span>
            </h2>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16 ha2-reveal">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold tracking-[-0.02em] text-gray-900 leading-tight">
              How Smart Hotel
              <br />
              <span className="text-amber-600">Automation Works</span>
            </h2>
            <p className="mt-4 text-gray-400 text-sm max-w-lg mx-auto">
              A unified system that runs invisibly — impressing guests and
              simplifying operations simultaneously.
            </p>
          </div>
            ...
            {steps.map((step, i) => (
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="ha2-step-num text-2xl font-bold text-gray-100 tracking-tight">
                    {step.num}
                  </span>
                </div>
                <div>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12 ha2-reveal">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold tracking-[-0.02em] text-gray-900">
              Why Every Hotel Owner
              <br />
              <span className="text-amber-600">Needs This Today</span>
            </h2>
            <p className="mt-4 text-gray-400 text-sm max-w-xl mx-auto">
              The gap between a 3-star and a 5-star experience is no longer
              about decor — it's about intelligence.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-px bg-gray-100 rounded-3xl overflow-hidden border border-gray-100 ha2-reveal">
            {[
              ...
              <div
                key={i}
                className="bg-white p-8 flex flex-col gap-4 hover:border-amber-100 hover:shadow-md transition-all duration-200"
              >

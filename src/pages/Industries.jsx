...
const industries = [
  {
    ...
    solutions: [{ label: 'HealNet', to: '/healnet' }, { label: 'VisiAI' }, { label: 'Agentra' }],
  },
  {
  ...
  },
  {
    ...
    solutions: [{ label: 'Enerlytix' }, { label: 'VisiAI' }, { label: 'AquaMind' }],
  },
  {
    ...
    solutions: [{ label: 'Enerlytix' }, { label: 'AquaMind' }],
  },
  {
    ...
    solutions: [{ label: 'Agentra' }, { label: 'Virtura' }, { label: 'NeuraLinka' }],
  },
  {
    ...
    solutions: [{ label: 'Agentra' }, { label: 'Privora' }],
  },
  {
    ...
    solutions: [{ label: 'Enerlytix' }, { label: 'VisiAI' }, { label: 'IoT Automation' }],
  },
];

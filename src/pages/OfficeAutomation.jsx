...
const useCases = [
  {
    ...
    points: ['Dimmable adaptive lighting', 'AC automation by occupancy', 'Meeting room automation', 'Director-level access control'],
    accent: 'blue',
  },
  {
    ...
    points: ['Scene-based lighting presets', 'Synchronized sound automation', 'Smart customer triggers', 'Closing-time auto-shutdown'],
    accent: 'slate',
  },
  {
    title: 'BMS System',
    ...
    points: ['Outdoor lighting automation', 'Fire system integration', 'STP / ETP automation', 'Pump & utility control'],
    accent: 'blue',
  },
  {
    title: 'Enterprise Security',
    ...
    points: ['Magnetic lock systems', 'Fingerprint & face unlock', 'Time-stamped access logs', 'Remote lock override'],
    accent: 'slate',
  },
  {
    ...
    points: ['One-tap projector automation', 'Motorized screen control', 'Audio-visual sync', 'Presentation lighting scenes'],
    accent: 'blue',
  },
];
...
const EyebrowLabel = ({ children, light = false }) => (
  <p className={`text-[11px] font-bold tracking-[0.18em] uppercase mb-3 ${light ? 'text-blue-300' : 'text-blue-600'}`}>
    {children}
  </p>
);
...
const OfficeAutomation = () => {
  ...
  useEffect(() => {
    ...
    document.querySelectorAll('.oa-reveal').forEach((el) => observerRef.current.observe(el));
    ...
    <>
      ...
      <section className="relative bg-[url('/assets/MainOfficeAutomation.jpg')] bg-cover bg-center min-h-[90vh] flex items-center justify-center text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 flex flex-col items-center gap-7">
          ...
          <p className="oa-hero-3 text-white/60 text-base sm:text-lg max-w-xl leading-relaxed font-light">
            From boardrooms to building infrastructure — automate, monitor, and command everything from a single seat of control.
          </p>

          <div className="oa-hero-4 flex items-center gap-4 flex-wrap justify-center">
            <button className="bg-blue-700 hover:bg-blue-600 text-white font-semibold text-sm px-8 py-3.5 rounded-full transition-all duration-200 hover:shadow-[0_0_28px_rgba(59,130,246,0.5)] hover:scale-[1.03] tracking-wide">
              Schedule a Demo
            </button>
        ...
        <div className="oa-badge absolute bottom-8 right-8 hidden md:flex items-center gap-3 bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl px-5 py-3.5">
          ...
          <div className="text-left">
            <p className="text-white text-xs font-bold">Director-Grade Control</p>
            <p className="text-white/50 text-[10px]">Full access · Any device · Any location</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-slate-950 border-b border-white/5 py-5 px-6">
        <div className="max-w-5xl mx-auto flex flex-wrap items-center justify-center gap-x-10 gap-y-3">
          {['Smart Offices', 'Retail Chains', 'BMS Facilities', 'Institutions', 'Multi-Tower Campuses'].map((item, i) => (
            <div key={i} className="flex items-center gap-2.5 text-white/50 text-xs font-semibold tracking-widest uppercase">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16 oa-reveal">
            ...
            <p className="mt-4 text-gray-400 text-sm max-w-lg mx-auto">
              A complete automation platform engineered for decision-makers who demand control, visibility, and performance.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-px bg-gray-100 rounded-3xl overflow-hidden border border-gray-100 shadow-sm">
            {features.map((f, i) => (
              ...
              >
                ...
                <div>
                  <h4 className="text-sm font-bold text-gray-900 leading-snug">{f.title}</h4>
      ...
      <section className="bg-gray-50 py-24 px-5">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-20 oa-reveal">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold tracking-[-0.02em] text-gray-900 leading-tight">
              Built for Every<br /><span className="text-blue-600">Commercial Environment</span>
            </h2>
          </div>
            ...
            <div className="relative z-10 px-10 py-16 sm:px-16 flex flex-col lg:flex-row items-center gap-12 oa-reveal">
              ...
              <div className="flex-1">
                ...
                <h2 className="text-3xl sm:text-4xl font-bold tracking-[-0.02em] text-white leading-tight">
                  Transform Your Commercial Space<br />
                  <span className="text-blue-300">into an Intelligent Ecosystem</span>
                </h2>
                <p className="mt-5 text-white/55 text-sm leading-relaxed max-w-lg">
                  Real-time operational control. Energy intelligence. Security oversight. Everything a director needs to run a smarter, leaner, and more responsive facility.
                </p>
              ...
              <div className="flex-shrink-0 w-full lg:w-72 flex flex-col gap-4">
                {[
                  { label: 'Energy Savings', value: '30%+', sub: 'vs. conventional systems', icon: <polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/> },
                  { label: 'Operational Control', value: '100%', sub: 'Unified dashboard access', icon: <><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8M12 17v4"/></> },
                  { label: 'Live Monitoring', value: '24/7', sub: 'Alerts, logs, and status', icon: <><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></> },
                ].map(({ label, value, sub, icon }, i) => (
                  <div key={i} className={`bg-white/8 hover:bg-white/12 border border-white/10 rounded-2xl px-6 py-5 flex items-center gap-4 transition-colors duration-200 oa-reveal oa-d${i + 1}`}>
                    ...
                    <div>
                      <p className="text-white text-xl font-bold tracking-[-0.02em]">{value}</p>
                      <p className="text-white/40 text-[11px] font-semibold uppercase tracking-widest mt-0.5">{label}</p>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12 oa-reveal">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold tracking-[-0.02em] text-gray-900">
              Built for the <span className="text-blue-600">Decision-Maker</span>
            </h2>
            <p className="mt-4 text-gray-400 text-sm max-w-xl mx-auto">
              Whether you're in the boardroom, traveling, or at home — your facility responds to you.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-px bg-gray-100 rounded-3xl overflow-hidden border border-gray-100 oa-reveal">
            {[
              ...
              <div key={i} className="bg-white p-8 flex flex-col gap-4 hover:border-blue-100 hover:shadow-md transition-all duration-200">

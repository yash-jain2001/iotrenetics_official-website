        ...
        <div className="space-y-8 text-lg">
          ...
          <section>
            ...
            <ul className="space-y-2">
              <li>
                <strong>Company:</strong> IoTrenetics Solutions Pvt. Ltd.
              </li>
              <li>
                ...
                <a
                  ...
                  className="text-accent underline hover:text-brand transition-colors"
                >
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 mb-4">
              <li>
                It does NOT provide financial, investment, or medical advice
              </li>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-brand">
              7. AI and Data Disclaimer
            </h2>
            <p className="mb-3">
              Our services may use AI and automated systems:
            </p>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <section>
            ...
            <p>
              are owned by IoTrenetics Solutions Pvt. Ltd.
              <br />
              <strong>Unauthorized use is prohibited.</strong>
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-3">
              We may rely on third-party services including:
            </p>
            <ul className="list-disc pl-6 space-y-2 mb-4">
          ...
          <section>
            ...
            <p className="mb-3">
              ...
              <br />
              IoTrenetics Solutions Pvt. Ltd. shall not be liable for:
            </p>
            <ul className="list-disc pl-6 space-y-2 mb-4">
            ...
            <p>
              Total liability shall not exceed the amount paid by the user (if
              any).
            </p>
          </section>
          ...
          <section className="">
            ...
            <ul className="space-y-3 font-medium">
              <li>
                <span className="text-gray-500 w-24 inline-block font-normal">
                  Company:
                </span>{" "}
